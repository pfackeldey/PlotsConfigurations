...
for m in masses:
    for model in models:
        model_name = model.replace("cprime", "c").replace(
            ".", "").replace("BRnew", "brn")
        nuisances['pdf_Higgs_gg']['samples'].update(
...
for m in masses:
    for model in models:
        model_name = model.replace("cprime", "c").replace(
            ".", "").replace("BRnew", "brn")
        nuisances['pdf_Higgs_qqbar']['samples'].update(
...
for m in masses:
    for model in models:
        model_name = model.replace("cprime", "c").replace(
            ".", "").replace("BRnew", "brn")
        if m < 1500:
            nuisances['pdf_Higgs_gg_ACCEPT']['samples'].update(
...
for m in masses:
    for model in models:
        model_name = model.replace("cprime", "c").replace(
            ".", "").replace("BRnew", "brn")
        if m < 1000:
            nuisances['pdf_Higgs_qqbar_ACCEPT']['samples'].update(
