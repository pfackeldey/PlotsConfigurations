...
# for personal MC ntuple with NN output:
directory = '/net/data_cms/institut_3b/fackeldey/nobackup/Apr2017_summer16/lepSel__MCWeights__bSFLpTEffMulti__cleanTauMC__l2loose__hadd__l2tightOR__LepTrgFix__dorochester__formulasMC__wwSel/'

treeBaseDir = '/net/data_cms/institut_3b/fackeldey/nobackup/'
################################################
############ NUMBER OF LEPTONS #################
################################################
...
if useDYHT:
    ...
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-5to50_HT-100to200', ptllDYW_LO)
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-5to50_HT-200to400', ptllDYW_LO)
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-5to50_HT-400to600', ptllDYW_LO)
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-5to50_HT-600toInf', ptllDYW_LO)
    ...
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-50_HT-100to200_ext1', ptllDYW_LO)
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-200to400', ptllDYW_LO)
    addSampleWeight(
        samples, 'DY', 'DYJetsToLL_M-50_HT-200to400_ext1', ptllDYW_LO)
    ...
    # Fix some x-sections
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-5to50_HT-70to100', getBaseW(
        directory, ['DYJetsToLL_M-5to50_HT-70to100']) + '/baseW')   # x-section update
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-70to100', getBaseW(directory,
                                                                          ['DYJetsToLL_M-50_HT-70to100']) + '/baseW')      # x-section update
    # set baseW across both samples
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-100to200', getBaseW(directory,
                                                                           ['DYJetsToLL_M-50_HT-100to200', 'DYJetsToLL_M-50_HT-100to200_ext1']) + '/baseW')
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-100to200_ext1', getBaseW(directory,
                                                                                ['DYJetsToLL_M-50_HT-100to200', 'DYJetsToLL_M-50_HT-100to200_ext1']) + '/baseW')
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-200to400', getBaseW(directory,
                                                                           ['DYJetsToLL_M-50_HT-200to400', 'DYJetsToLL_M-50_HT-200to400_ext1']) + '/baseW')
    addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-200to400_ext1', getBaseW(directory,
                                                                                ['DYJetsToLL_M-50_HT-200to400', 'DYJetsToLL_M-50_HT-200to400_ext1']) + '/baseW')
...
if useDYtt:
    ...
    # set baseW across both samples
    addSampleWeight(samples, 'DY', 'DYJetsToTT_MuEle_M-50', getBaseW(directory,
                                                                     ['DYJetsToTT_MuEle_M-50', 'DYJetsToTT_MuEle_M-50_ext1']) + '/baseW')
    addSampleWeight(samples, 'DY', 'DYJetsToTT_MuEle_M-50_ext1', getBaseW(directory,
                                                                          ['DYJetsToTT_MuEle_M-50', 'DYJetsToTT_MuEle_M-50_ext1']) + '/baseW')
    if useDYHT:
        ...
        addSampleWeight(
            samples, 'DY', 'DYJetsToLL_M-50_HT-100to200_ext1', cutSF)
        addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-200to400', cutSF)
        addSampleWeight(
            samples, 'DY', 'DYJetsToLL_M-50_HT-200to400_ext1', cutSF)
        ...
        if mixDYttandHT:
            addSampleWeight(
                samples, 'DY', 'DYJetsToTT_MuEle_M-50', genHT + '<450')
            addSampleWeight(
                samples, 'DY', 'DYJetsToTT_MuEle_M-50_ext1', genHT + '<450')
            addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-400to600',
                            '(' + cutSF + ')||(' + genHT + '>=450)')
            addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-600to800',
                            '(' + cutSF + ')||(' + genHT + '>=450)')
            addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-800to1200',
                            '(' + cutSF + ')||(' + genHT + '>=450)')
            addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-1200to2500',
                            '(' + cutSF + ')||(' + genHT + '>=450)')
            addSampleWeight(samples, 'DY', 'DYJetsToLL_M-50_HT-2500toInf',
                            '(' + cutSF + ')||(' + genHT + '>=450)')
        else:
            addSampleWeight(
                samples, 'DY', 'DYJetsToLL_M-50_HT-400to600', cutSF)
            addSampleWeight(
                samples, 'DY', 'DYJetsToLL_M-50_HT-600to800', cutSF)
            addSampleWeight(
                samples, 'DY', 'DYJetsToLL_M-50_HT-800to1200', cutSF)
            addSampleWeight(
                samples, 'DY', 'DYJetsToLL_M-50_HT-1200to2500', cutSF)
            addSampleWeight(
                samples, 'DY', 'DYJetsToLL_M-50_HT-2500toInf', cutSF)
...
##gROOT.ProcessLineSync(".L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/deltaRMatch.C+");
##gROOT.ProcessLineSync(".L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/cleanJetIndex.C+");
##gROOT.ProcessLineSync(".L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/mjjGen.C+");
...
samples['WW'] = {'name': getSampleFiles(directory, 'WWTo2L2Nu'),
                 ...
                 'linesToAdd': ['.L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/cleanJetIndex.C+', '.L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/deltaRMatch.C+ ', '.L ~/master/CMSSW_8_0_26_patch1/src/PlotsConfigurations/Configurations/EXO/WWlvlv_VBF/Full2016/mjjGen.C+']
                 }
...
for m in masses:
    for model in models:
        ...
        m_list = ['120', '125', '130', '135', '140', '145',
                  '150', '155', '160', '165', '170', '175', '180', '190']
        if m in my_list:
            ...
            samples['ggH_hww_SBI' + m + '_' + model_name] = {'name': getSampleFiles(directory, 'GluGluHToWWTo2L2Nu_M' + m) +
                                                             ...
                                                             getSampleFiles(
                directory, 'GluGluHToWWTo2L2NuPowheg_M125'),
                'weight':  XSWeight + '*' + SFweight + '*' + GenLepMatch + '*' + METFilter_MC,
            ...
            samples['qqH_hww_SBI' + m + '_' + model_name] = {'name': getSampleFiles(directory, 'VBFHToWWTo2L2Nu_M' + m) +
                                                             ...
                                                             getSampleFiles(
                directory, 'VBFHToWWTo2L2Nu_M125'),
                ...
                'weights': [model,
                            ...
                            '*(abs(' + model_int + ')<10)',
                            '(' + mjjGen +
                            '>100)*(std_vector_LHEparton_id[0]!=21 &&  std_vector_LHEparton_id[1]!=21)',
                            '1.']

            }
        elif m in m_list:  # set model := '1.' and model_int := '0.'
            samples['ggH_hww_' + m + '_' + model_name] = {'name': getSampleFiles(directory, 'GluGluHToWWTo2L2Nu_M' + m),


                                                          'weight': XSWeight + '*' + SFweight + '*' + GenLepMatch + '*' + METFilter_MC + '*' + '1.' + '*' + str(sf),
                                                          'suppressNegativeNuisances': ['all'],
                                                          }
...
for Run in DataRun:
    directory = treeBaseDir + 'Apr2017_Run2016' + \
        Run[0] + '_RemAOD/lepSel__EpTCorr__TrigMakerData__cleanTauData__l2loose__multiFakeW__formulasFAKE__hadd' + skimFake + '/'
...
for Run in DataRun:
    directory = treeBaseDir + 'Apr2017_Run2016' + \
        Run[0] + '_RemAOD/lepSel__EpTCorr__TrigMakerData__cleanTauData__l2loose__hadd__l2tightOR__formulasDATA' + skim + '/'
    for DataSet in DataSets:
        FileTarget = getSampleFiles(directory, DataSet + '_' + Run[1], True)
        for iFile in FileTarget:
